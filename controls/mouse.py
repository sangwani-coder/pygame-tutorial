...
def checkBounds():
    ...
    if mousePressed == True:
        ...
        if mousePosition[0] > squareX and mousePosition[1] < squareY + squareSize:
...
def drawSquare():
    ...
    pygame.draw.rect(surface, squareColor,
...
while True:
    ...
    surface.fill((0, 0, 0))
    # Check whether mouse is pressed down in the tuple (L,M,R)
